<div class="flex flex-col min-h-screen justify-center items-center gap-5">
    <h1 class="text-xl font-bold mt-3">Le tue ricette</h1>
    <ul class="flex flex-col rounded-md overflow-hidden gap-3">
        <?php foreach ($params["recipes"] as $recipe): ?>
            <li class="flex flex-row items-center justify-center gap-20 p-3 border-2 border-legno bg-crema overflow-hidden rounded-md">
                <div class="flex flex-col items-center justify-center basis-2/7">
                ...
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <p><?php echo "€" . $recipe["costoTotale"] . " (€" . number_format($recipe["costoTotale"] / $recipe["porzioni"], 2) . " per porzione)" ?></p>
                </div>
                <div class="flex flex-row gap-3 justify-end flex-1 text-center">
